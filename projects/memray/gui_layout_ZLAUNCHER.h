...
#ifndef GUI_LAYOUT_ZLAUNCHER_H
#define GUI_LAYOUT_ZLAUNCHER_H
...
#endif // GUI_LAYOUT_ZLAUNCHER_H

/***********************************************************************************
*
*   GUI_LAYOUT_ZLAUNCHER IMPLEMENTATION
*
************************************************************************************/
#if defined(GUI_LAYOUT_ZLAUNCHER_IMPLEMENTATION)
...
void GuiLayout(GuiLayoutState *state)
{
    ...
    GuiGroupBox(state->layoutRecs[21], GroupBoxMAINText);
    GuiGroupBox(state->layoutRecs[22], GroupBoxMETRICSText);
}

#endif // GUI_LAYOUT_ZLAUNCHER_IMPLEMENTATION
