musl-gcc -static testlayout.c zlayout.c -o test_layout
sudo openvt -f -c 2 -s -w -- ./r.sh
 
///gamescope///
gamescope -- bash -c "sleep 5  && GSK_RENDERER=cairo WAYLAND_DISPLAY=wayland-1 ./zxdg"
musl-gcc -static -O2     zgui.c zlayout.c  zoutput.c xdg-shell.c      -I"$ZSYS/include"     -I"$ZSYS/include/cairo"     -L"$ZSYS/lib"     -Wl,--start-group     -lcairo     -lpixman-1     -lfreetype     -lpng     -lwayland-client     -lffi     -lm     -ldl     -lrt -lz    -lpthread     -Wl,--end-group     -o zgui
