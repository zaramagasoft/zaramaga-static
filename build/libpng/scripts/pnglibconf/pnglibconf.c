 PNG_DFN "/* 1.8.0 STANDARD API DEFINITION */" 
/*- pnglibconf.dfn intermediate file
 * generated from scripts/pnglibconf/pnglibconf.dfa
 */
 PNG_DFN "/* pnglibconf.h - library build configuration */" 
 PNG_DFN "" 
 PNG_DFN "/* libpng version 1.8.0.git */" 
 PNG_DFN "" 
 ...
 PNG_DFN "/* Derived from: scripts/pnglibconf/pnglibconf.dfa */" 
file pnglibconf.h scripts/pnglibconf/pnglibconf.dfa PNGLCONF_H
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_APNG_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_APNG
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_APNG_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_APNG_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_APNG_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_WRITE_APNG_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_WRITE_APNG
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_WRITE_APNG_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_WRITE_APNG_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_WRITE_APNG_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_READ_APNG_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_READ_APNG
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_READ_APNG_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_READ_APNG_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_READ_APNG_SUPPORTED*/" 
#endif
...
/* option: TARGET_SPECIFIC_CODE enabled
 *   requires:   READ
 *   if:        
 *   enabled-by:
 *   sets:       */
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_TARGET_SPECIFIC_CODE_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      ifdef PNG_NO_TARGET_SPECIFIC_CODE
#       undef PNG_on /*turned off*/
#      endif
#      ifdef PNG_NO_TARGET_SPECIFIC_CODE_SUPPORTED
#       undef PNG_on /*turned off*/
#      endif
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_TARGET_SPECIFIC_CODE_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_TARGET_SPECIFIC_CODE_SUPPORTED*/" 
#endif
